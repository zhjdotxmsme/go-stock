...
export namespace data {
	...
	export class GapInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.date = source["date"];
	        this.gapLow = source["gapLow"];
	        this.gapHigh = source["gapHigh"];
	        this.widthPct = source["widthPct"];
	        this.filled = source["filled"];
	        this.fillDate = source["fillDate"];
	...
	export class GapAnalysis {
	    ...
	    static createFrom(source: any = {}) {
	        return new GapAnalysis(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.window = source["window"];
	        this.unfilledCount = source["unfilledCount"];
	        this.recent = this.convertValues(source["recent"], GapInfo);
	        this.status = source["status"];
	    }
	...
	export class IndicatorResult {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.gap = this.convertValues(source["gap"], GapAnalysis);
	    }
...
export namespace models {
	...
	export class DailyPick {
	    ...
	    concepts: string;
	    industryRank: number;
	    boardHeatLatest: number;
	    boardHeatTrend: number;
	    boardHeatPersistence: number;
	    boardHeatCooling: number;
	    boardHeatWatchCount: number;
	    boardHeatSummary: string;
	    boardHeatState: string;
	    change60dPct: number;
	    signalScore: number;
	    macdStatus: string;
	    rsiStatus: string;
	    breakout20dPct: number;
	    amplitudePct: number;
	    volumeRatio20d: number;
	    bodyPct: number;
	    pullbackMa20: boolean;
	    ...
	    riskFlags: string;
	    riskChecks: string;
	    excludedByRisk: boolean;
	    portfolioPenalty: number;
	    portfolioFlags: string;
	    postAnalysisStatus: string;
	    postAnalysisCompleted: boolean;
	    postAnalysisScoreDelta: number;
	    postAnalysisLocalDelta: number;
	    postAnalysisRemoteDelta: number;
	    postAnalysisDetail: string;
	    reason: string;
	    remarks: string;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.rankingReason = source["rankingReason"];
	        this.amount = source["amount"];
	        this.totalMv = source["totalMv"];
	        this.volumeRatio = source["volumeRatio"];
	        this.peRatio = source["peRatio"];
	        this.pbRatio = source["pbRatio"];
	        this.industry = source["industry"];
	        this.concepts = source["concepts"];
	        this.industryRank = source["industryRank"];
	        this.boardHeatLatest = source["boardHeatLatest"];
	        this.boardHeatTrend = source["boardHeatTrend"];
	        this.boardHeatPersistence = source["boardHeatPersistence"];
	        this.boardHeatCooling = source["boardHeatCooling"];
	        this.boardHeatWatchCount = source["boardHeatWatchCount"];
	        this.boardHeatSummary = source["boardHeatSummary"];
	        this.boardHeatState = source["boardHeatState"];
	        this.change60dPct = source["change60dPct"];
	        this.signalScore = source["signalScore"];
	        this.macdStatus = source["macdStatus"];
	        this.rsiStatus = source["rsiStatus"];
	        this.breakout20dPct = source["breakout20dPct"];
	        this.amplitudePct = source["amplitudePct"];
	        this.volumeRatio20d = source["volumeRatio20d"];
	        this.bodyPct = source["bodyPct"];
	        this.pullbackMa20 = source["pullbackMa20"];
	        this.consolidationDays = source["consolidationDays"];
	        this.volatility20dPct = source["volatility20dPct"];
	        this.maxDrawdownPct = source["maxDrawdownPct"];
	        this.atr14 = source["atr14"];
	        this.dailyQualityScore = source["dailyQualityScore"];
	        this.dailyQualityFlags = source["dailyQualityFlags"];
	        this.dailySource = source["dailySource"];
	        this.factorScores = source["factorScores"];
	        this.llmConfidence = source["llmConfidence"];
	        this.llmSector = source["llmSector"];
	        this.llmTheme = source["llmTheme"];
	        this.llmThesis = source["llmThesis"];
	        this.llmReason = source["llmReason"];
	        this.llmRisk = source["llmRisk"];
	        this.llmCatalysts = source["llmCatalysts"];
	        this.llmRiskFlags = source["llmRiskFlags"];
	        this.llmTags = source["llmTags"];
	        this.llmStyleFit = source["llmStyleFit"];
	        this.llmWatchItems = source["llmWatchItems"];
	        this.llmInvalidators = source["llmInvalidators"];
	        this.riskScore = source["riskScore"];
	        this.riskLevel = source["riskLevel"];
	        this.riskPenalty = source["riskPenalty"];
	        this.riskFlags = source["riskFlags"];
	        this.riskChecks = source["riskChecks"];
	        this.excludedByRisk = source["excludedByRisk"];
	        this.portfolioPenalty = source["portfolioPenalty"];
	        this.portfolioFlags = source["portfolioFlags"];
	        this.postAnalysisStatus = source["postAnalysisStatus"];
	        this.postAnalysisCompleted = source["postAnalysisCompleted"];
	        this.postAnalysisScoreDelta = source["postAnalysisScoreDelta"];
	        this.postAnalysisLocalDelta = source["postAnalysisLocalDelta"];
	        this.postAnalysisRemoteDelta = source["postAnalysisRemoteDelta"];
	        this.postAnalysisDetail = source["postAnalysisDetail"];
	        this.reason = source["reason"];
	        this.remarks = source["remarks"];
	    }
